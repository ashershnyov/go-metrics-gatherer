...
const file_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB;Z9github.com/ashershnyov/go-metrics-gatherer/internal/protob\x06proto3"
